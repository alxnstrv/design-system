...
const catData = allCats.find(c => c.name === "Add to Favorites component");
...
function AddToFavoritesComponent(props) {
...
export default {
  title: "Widgets/Add to Favorites component",
  component: AddToFavoritesComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["Mobile","Desktop","desktop","mobile"] },
    "State": { control: 'select', options: ["Default","Hover","Added","Error","Added 2"] },
    "Breakpoint": { control: 'select', options: ["desktop","768","360","540","320"] }
  },
};
