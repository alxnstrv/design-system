...
const catData = allCats.find(c => c.name === "Radio Button Component");
...
export default {
  title: "Tokens   Atoms/Radio Button Component",
  component: RadioButtonComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "State": { control: 'select', options: ["Error","Hover","Hover Selected","Selected","Focus","Disabled","Default","Selected \u2028Disabled"] }
  },
};
