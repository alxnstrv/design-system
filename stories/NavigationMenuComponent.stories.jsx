...
const catData = allCats.find(c => c.name === "Navigation Menu component");
...
export default {
  title: "Navigation/Navigation Menu component",
  component: NavigationMenuComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["540","768","320","1024","1440","1280","360"] }
  },
};
