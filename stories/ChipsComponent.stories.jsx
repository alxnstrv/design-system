...
const catData = allCats.find(c => c.name === "Chips Component");
...
export default {
  title: "Tokens   Atoms/Chips Component",
  component: ChipsComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["mobile","desktop"] },
    "State": { control: 'select', options: ["Default","active","focus","pressed","disabled","hover"] },
