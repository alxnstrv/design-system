...
const catData = allCats.find(c => c.name === "pointer+info");
...
export default {
  title: "Tokens   Atoms/pointer+info",
  component: PointerInfo,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Property": { control: 'select', options: ["vertical","horizontal"] }
  },
};
