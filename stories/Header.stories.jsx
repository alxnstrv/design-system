...
const catData = allCats.find(c => c.name === "Header");
...
export default {
  ...
  argTypes: {
    "size": { control: 'select', options: ["767-540","1280","1024","1440","360","320","768"] },
    "bg": { control: 'select', options: ["contrast","scrolled","light"] }
  },
};
