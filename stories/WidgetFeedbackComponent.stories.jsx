...
const catData = allCats.find(c => c.name === "Widget Feedback component");
...
function WidgetFeedbackComponent(props) {
...
export default {
  title: "Widgets/Widget Feedback component",
  component: WidgetFeedbackComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "status": { control: 'select', options: ["on","off"] },
    "breakpoint": { control: 'select', options: ["desktop","mobile"] },
    "Breakpoint": { control: 'select', options: ["1440-1024","360","320"] },
    "state": { control: 'select', options: ["success","сollapsed","positive","error","error 2","negative"] }
  },
};
