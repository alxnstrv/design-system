...
const catData = allCats.find(c => c.name === "Hero Banner Category component");
...
function HeroBannerCategoryComponent(props) {
...
export default {
  title: "Interface Blocks/Hero Banner Category component",
  component: HeroBannerCategoryComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Size": { control: 'select', options: ["—","S","L"] },
    "Breakpoint": { control: 'select', options: ["320","1024","360","1280","768","1440-1024","1440","540"] },
    "Amount": { control: 'select', options: ["3","1","2"] }
  },
};
