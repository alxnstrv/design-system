...
const catData = allCats.find(c => c.name === "Big Field Component");
...
function BigFieldComponent(props) {
...
export default {
  title: "Tokens   Atoms/Big Field Component",
  component: BigFieldComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["mobile","desktop"] },
    "State": { control: 'select', options: ["Error","FilledScroll","ActiveScroll","Filled","default","NonActive","Active","hover"] },
