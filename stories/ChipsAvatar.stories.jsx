...
const catData = allCats.find(c => c.name === "chips+avatar");
...
export default {
  title: "Cards/chips+avatar",
  component: ChipsAvatar,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "type": { control: 'select', options: ["chip","countries"] }
  },
};
