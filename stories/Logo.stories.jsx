...
const catData = allCats.find(c => c.name === "Logo");
...
export default {
  title: "Tokens   Atoms/Logo",
  component: Logo,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Theme": { control: 'select', options: ["business","base"] },
    "Size": { control: 'select', options: ["Default","small","32px","56px"] },
