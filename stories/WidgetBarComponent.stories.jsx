...
const catData = allCats.find(c => c.name === "Widget bar component");
...
function WidgetBarComponent(props) {
...
export default {
  title: "Widgets/Widget bar component",
  component: WidgetBarComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Property": { control: 'select', options: ["Opened","Closed"] },
