...
const catData = allCats.find(c => c.name === "Pagination Button Component");
...
function PaginationButtonComponent(props) {
...
export default {
  title: "Tokens   Atoms/Pagination Button Component",
  component: PaginationButtonComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Property": { control: 'select', options: ["accent"] },
    "state": { control: 'select', options: ["disabled","Default","active","hover"] },
    "size": { control: 'select', options: ["s"] },
