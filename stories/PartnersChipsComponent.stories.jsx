...
const catData = allCats.find(c => c.name === "Partners chips Component");
...
function PartnersChipsComponent(props) {
...
export default {
  title: "Tokens   Atoms/Partners chips Component",
  component: PartnersChipsComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["Desktop","Mobile"] },
    "Property": { control: 'select', options: ["1","2","3","4"] }
  },
};
