...
const catData = allCats.find(c => c.name === "Recommendation Carousel Component");
...
function RecommendationCarouselComponent(props) {
...
export default {
  title: "Cards/Recommendation Carousel Component",
  component: RecommendationCarouselComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Size": { control: 'select', options: ["360","1440","1280","320","1024","768","540"] }
  },
};
