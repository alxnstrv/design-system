...
const catData = allCats.find(c => c.name === "Select Component");
...
export default {
  title: "Tokens   Atoms/Select Component",
  component: SelectComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["mobile","desktop"] },
    "State": { control: 'select', options: ["Filled","NonActive","Opened","Error","hover","Reopened","Selected","default"] },
