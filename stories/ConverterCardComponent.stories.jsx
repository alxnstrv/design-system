...
const catData = allCats.find(c => c.name === "Converter Card component");
...
function ConverterCardComponent(props) {
...
export default {
  title: "Interface Blocks/Converter Card component",
  component: ConverterCardComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["540","768","360","1280","1024","1440","320"] },
    "Type": { control: 'select', options: ["loading","Default","success"] }
  },
};
