...
const catData = allCats.find(c => c.name === "Tooltip component");
...
export default {
  title: "Tokens   Atoms/Tooltip component",
  component: TooltipComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["mobile","desktop"] },
    "State": { control: 'select', options: ["pressed","Default","hover"] },
    "Pointer": { control: 'select', options: ["botom","top","left","right"] }
  },
};
