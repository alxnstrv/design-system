...
const catData = allCats.find(c => c.name === "Discalmer  Component");
...
function DiscalmerComponent(props) {
...
export default {
  title: "Tokens   Atoms/Discalmer  Component",
  component: DiscalmerComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "state": { control: 'select', options: ["close","open"] },
