...
const catData = allCats.find(c => c.name === "Tabs Component");
...
export default {
  title: "Tokens   Atoms/Tabs Component",
  component: TabsComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "amount": { control: 'select', options: ["4","9","2","10","3","6","5","11","7","8","12"] },
    "style": { control: 'select', options: ["primary","transparency"] },
    "breakpoint": { control: 'select', options: ["desktop","mobile"] },
    "size": { control: 'select', options: ["M","S"] },
    "state": { control: 'select', options: ["disabled","hover","active","default"] },
    "type": { control: 'select', options: ["right","left"] },
    "property": { control: 'select', options: ["Default","hover"] }
  },
};
