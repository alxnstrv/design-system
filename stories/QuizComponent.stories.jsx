...
const catData = allCats.find(c => c.name === "Quiz component");
...
export default {
  title: "Interface Blocks/Quiz component",
  component: QuizComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Property": { control: 'select', options: ["20","Variant10","40","Variant9","60","Variant8","80","Variant7","100","Variant6"] },
    "Device": { control: 'select', options: ["Desktop","Mobile"] },
    "Type": { control: 'select', options: ["Checkbox","Radio"] },
    "Breakpoint": { control: 'select', options: ["540","1024","1440","768","Breakpoint4","1280","320"] }
  },
};
