...
const catData = allCats.find(c => c.name === "Navigation card block");
...
function NavigationCardBlock(props) {
...
export default {
  title: "Cards/Navigation card block",
  component: NavigationCardBlock,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["1280","768","1024","540","1440px","320","360"] }
  },
};
