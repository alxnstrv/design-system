...
const catData = allCats.find(c => c.name === "Combobox Component");
...
export default {
  title: "Tokens   Atoms/Combobox Component",
  component: ComboboxComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["mobile","desktop"] },
    "State": { control: 'select', options: ["NonActive","default","error","hover","typing","filled","active"] },
