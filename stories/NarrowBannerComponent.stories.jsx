...
const catData = allCats.find(c => c.name === "Narrow Banner component");
...
function NarrowBannerComponent(props) {
...
export default {
  title: "Interface Blocks/Narrow Banner component",
  component: NarrowBannerComponent,
