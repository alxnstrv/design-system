...
const catData = allCats.find(c => c.name === "Pagination");
...
export default {
  title: "Tokens   Atoms/Pagination",
  component: Pagination,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Property 1": { control: 'select', options: ["1440","Default","Variant4","Variant6","Variant3","Variant5","Variant7"] }
  },
};
