...
const catData = allCats.find(c => c.name === "FOS card component");
...
function FOSCardComponent(props) {
...
export default {
  title: "Interface Blocks/FOS card component",
  component: FOSCardComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Type": { control: 'select', options: ["default","reserve","success"] },
