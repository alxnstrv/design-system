...
const catData = allCats.find(c => c.name === "News Image Card component");
...
function NewsImageCardComponent(props) {
...
export default {
  title: "Cards/News Image Card component",
  component: NewsImageCardComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "breakpoint": { control: 'select', options: ["1440 - 1024","768 - 320","1024","768","360","1440-1280","320","540"] }
  },
};

export const Default = {
  args: {
    "breakpoint": "1440 - 1024"
  },
};
