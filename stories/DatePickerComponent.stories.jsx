...
const catData = allCats.find(c => c.name === "Date picker Component");
...
export default {
  title: "Tokens   Atoms/Date picker Component",
  component: DatePickerComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "State": { control: 'select', options: ["FixedDataOpen","FixedDataClose","Disabled Filled","ErrorOpen","FocusTypingOpen","Filled","PressedPeriod","FixedPeriodOpen","Default Close","PressedOneDay","ErrorClose","HoverPeriod","Default Open","Disabled","Hover"] },
