...
const catData = allCats.find(c => c.name === "News Card");
...
export default {
  title: "Cards/News Card",
  component: NewsCard,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "breakpoint": { control: 'select', options: ["768","1440","1280","1024","540","360","320","breakpoint8"] },
    "type": { control: 'select', options: ["News","Standart Layout"] },
    "state": { control: 'select', options: ["Hover","Default"] },
    "Sceletone": { control: 'select', options: ["Off","Yes"] }
  },
};
