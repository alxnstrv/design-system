...
const catData = allCats.find(c => c.name === "Bullets Component");
...
function BulletsComponent(props) {
...
export default {
  title: "Tokens   Atoms/Bullets Component",
  component: BulletsComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Type": { control: 'select', options: ["dots","Number","Text dash"] },
