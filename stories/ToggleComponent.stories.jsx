...
const catData = allCats.find(c => c.name === "Toggle component");
...
export default {
  title: "Tokens   Atoms/Toggle component",
  component: ToggleComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "state": { control: 'select', options: ["default","disabled","active"] },
    "text": { control: 'select', options: ["On","Off"] },
    "textWeight": { control: 'select', options: ["regular","medium"] },
    "breakpoint": { control: 'select', options: ["mobile","desktop"] },
    "textPosition": { control: 'select', options: ["left","right","Default"] }
  },
};
