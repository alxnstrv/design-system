...
const catData = allCats.find(c => c.name === "Widget SMB component");
...
function WidgetSMBComponent(props) {
...
export default {
  title: "Widgets/Widget SMB component",
  component: WidgetSMBComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["Desktop","Mobile"] },
    "State": { control: 'select', options: ["Hover","Default","Tap"] }
  },
};
