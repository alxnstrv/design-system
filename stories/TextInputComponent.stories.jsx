...
const catData = allCats.find(c => c.name === "Text Input Component");
...
export default {
  title: "Tokens   Atoms/Text Input Component",
  component: TextInputComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["mobile","desktop"] },
    "State": { control: 'select', options: ["Active","hover","NonActive","default","Typing","Filled","Error"] },
