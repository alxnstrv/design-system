...
const catData = allCats.find(c => c.name === "18.11 Слайдер, мобилка");
...
export default {
  title: "Interface Blocks/18.11 Слайдер, мобилка",
  component: C1811,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Property 1": { control: 'select', options: ["Default1","Default"] }
  },
};
