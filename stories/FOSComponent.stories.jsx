...
const catData = allCats.find(c => c.name === "FOS Расчетный счет component");
...
export default {
  title: "Interface Blocks/FOS Расчетный счет component",
  component: FOSComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["1440","1280","540","1024","768","360","320"] },
