...
const catData = allCats.find(c => c.name === "Modal mobile component");
...
function ModalMobileComponent(props) {
...
export default {
  title: "Tokens   Atoms/Modal mobile component",
  component: ModalMobileComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["768","320","540","360"] }
  },
};
