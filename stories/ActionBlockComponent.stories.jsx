...
const catData = allCats.find(c => c.name === "Action block component");
...
function ActionBlockComponent(props) {
...
export default {
  title: "Interface Blocks/Action block component",
  component: ActionBlockComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["1024","768","1440","1280","360","320","540"] }
  },
};
