...
const catData = allCats.find(c => c.name === "14.11 Слайдер, десктоп");
...
export default {
  title: "Interface Blocks/14.11 Слайдер, десктоп",
  component: C1411,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Property 1": { control: 'select', options: ["Default1","Default","Variant3"] }
  },
};
