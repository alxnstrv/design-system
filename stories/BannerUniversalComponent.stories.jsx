...
const catData = allCats.find(c => c.name === "Banner Universal component");
...
function BannerUniversalComponent(props) {
...
export default {
  title: "Interface Blocks/Banner Universal component",
  component: BannerUniversalComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["360","320","1440-1280","768","540","Desktop","Mobile"] },
    "Type": { control: 'select', options: ["Default","Centered","Text","Bullets"] }
  },
};
