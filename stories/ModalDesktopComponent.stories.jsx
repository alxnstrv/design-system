...
const catData = allCats.find(c => c.name === "Modal desktop component");
...
function ModalDesktopComponent(props) {
...
export default {
  title: "Tokens   Atoms/Modal desktop component",
  component: ModalDesktopComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Scroll": { control: 'select', options: ["yes","no"] },
