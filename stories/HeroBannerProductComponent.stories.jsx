...
const catData = allCats.find(c => c.name === "Hero Banner Product component");
...
function HeroBannerProductComponent(props) {
...
export default {
  title: "Interface Blocks/Hero Banner Product component",
  component: HeroBannerProductComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["1440","1024","768","1280","360","320","540"] },
    "Type": { control: 'select', options: ["Centered","Left-justified"] }
  },
};
