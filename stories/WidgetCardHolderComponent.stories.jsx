...
const catData = allCats.find(c => c.name === "Widget Card Holder component");
...
function WidgetCardHolderComponent(props) {
...
export default {
  title: "Widgets/Widget Card Holder component",
  component: WidgetCardHolderComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["Desktop","Mobile"] },
    "State": { control: 'select', options: ["Active","Hover","Tap","Default"] }
  },
};
