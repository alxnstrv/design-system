...
const catData = allCats.find(c => c.name === "Footer");
...
export default {
  title: "Interface Blocks/Footer",
  component: Footer,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["540","768","1280","360","320","1440","1024"] },
    "breakpoint": { control: 'select', options: ["1024","1440","360","1280","320","540","768"] },
