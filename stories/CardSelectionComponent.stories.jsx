...
const catData = allCats.find(c => c.name === "Card selection component");
...
function CardSelectionComponent(props) {
...
export default {
  title: "Interface Blocks/Card selection component",
  component: CardSelectionComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["Desktop","320","360","540","768","Mobile"] },
    "Property": { control: 'select', options: ["1","2","5","3","4"] },
    "Type": { control: 'select', options: ["Cards","Cards vertical","Phone+stickers","Stickers"] }
  },
};
