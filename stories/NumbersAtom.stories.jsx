...
const catData = allCats.find(c => c.name === "NumbersAtom");
...
export default {
  title: "Tokens   Atoms/NumbersAtom",
  component: NumbersAtom,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["Mobile","Desktop"] },
    "Style": { control: 'select', options: ["Base","Accent"] },
    "Size": { control: 'select', options: ["L","S","M"] },
    "Subline position": { control: 'select', options: ["bottom","top"] }
  },
};
