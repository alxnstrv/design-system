...
const catData = allCats.find(c => c.name === "breadcrumbs");
...
export default {
  title: "Tokens   Atoms/breadcrumbs",
  component: Breadcrumbs,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "State": { control: 'select', options: ["Default","Hover","Active"] },
    "Device": { control: 'select', options: ["Desktop","Mobile"] },
    "Style": { control: 'select', options: ["Primary","Contrast"] },
    "Amount": { control: 'select', options: ["1","3","4","2"] }
  },
};
