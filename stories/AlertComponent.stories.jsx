...
const catData = allCats.find(c => c.name === "Alert component");
...
export default {
  title: "Tokens   Atoms/Alert component",
  component: AlertComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["Mobile","Desktop"] },
    "Size": { control: 'select', options: ["M","L","S"] },
    "Type": { control: 'select', options: ["Error","Inverse","Muted","Secondary","Primary","success"] }
  },
};
