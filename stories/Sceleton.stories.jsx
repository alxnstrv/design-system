...
const catData = allCats.find(c => c.name === "Sceleton");
...
export default {
  title: "Tokens   Atoms/Sceleton",
  component: Sceleton,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Type": { control: 'select', options: ["Square","Round"] },
    "Animation Position": { control: 'select', options: ["Left","Centre","Right"] }
  },
};
