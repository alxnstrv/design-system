...
const catData = allCats.find(c => c.name === "Accordion component");
...
export default {
  title: "Interface Blocks/Accordion component",
  component: AccordionComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["540","320","1280","1024","768","1440","360"] },
