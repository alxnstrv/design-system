...
const catData = allCats.find(c => c.name === "Сountries chips Component");
...
function OuntriesChipsComponent(props) {
...
export default {
  title: "Tokens   Atoms/Сountries chips Component",
  component: OuntriesChipsComponent,
