...
const catData = allCats.find(c => c.name === "Investment Block");
...
function InvestmentBlock(props) {
...
export default {
  title: "Interface Blocks/Investment Block",
  component: InvestmentBlock,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "amount": { control: 'select', options: ["min","max"] },
    "breakpount": { control: 'select', options: ["desktop","mobile"] },
    "state": { control: 'select', options: ["Typing","Filled","Default","Hover","TextFilled"] },
    "breakpoint": { control: 'select', options: ["Desktop","Mobile"] },
    "Property 1": { control: 'select', options: ["1024","1440 -1280","768","320-320","540"] },
    "type": { control: 'select', options: ["currencies","investment"] }
  },
};
