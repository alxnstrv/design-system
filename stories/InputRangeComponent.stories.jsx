...
const catData = allCats.find(c => c.name === "Input Range Component (архивный ) 🔴");
...
export default {
  title: "Tokens   Atoms/Input Range Component (архивный ) 🔴",
  component: InputRangeComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "State": { control: 'select', options: ["Default","Hover","Disabled","Hover Track","Error","Active Field"] },
    "Grade": { control: 'select', options: ["Middle","Min","Max"] },
