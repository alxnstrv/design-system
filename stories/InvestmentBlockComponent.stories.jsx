...
const catData = allCats.find(c => c.name === "Investment block component");
...
function InvestmentBlockComponent(props) {
...
export default {
  title: "Interface Blocks/Investment block component",
  component: InvestmentBlockComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Breakpoint": { control: 'select', options: ["1440","1280","1024","360","320","540","768"] },
    "Device": { control: 'select', options: ["Desktop","Mobile"] },
    "State": { control: 'select', options: ["Active","Expanded","Default","hover","active"] },
    "Size": { control: 'select', options: ["desktop","mobile"] },
    "Open": { control: 'select', options: ["No","Yes"] },
