...
const catData = allCats.find(c => c.name === "Instruction Block component");
...
function InstructionBlockComponent(props) {
...
export default {
  title: "Interface Blocks/Instruction Block component",
  component: InstructionBlockComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["1440","360","320","1024","540","768","1280"] }
  },
};
