...
const catData = allCats.find(c => c.name === "Mobile m 360px");
...
export default {
  title: "Cards/Mobile m 360px",
  component: MobileM360px,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Size": { control: 'select', options: ["359-320"] },
    "Type": { control: 'select', options: ["No Tag"] }
  },
};
