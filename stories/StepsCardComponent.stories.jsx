...
const catData = allCats.find(c => c.name === "Steps Card component");
...
function StepsCardComponent(props) {
...
export default {
  title: "Cards/Steps Card component",
  component: StepsCardComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "breakpoint": { control: 'select', options: ["1440","1280","1024","540","768","320","360"] },
    "type": { control: 'select', options: ["no text","full"] },
    "width": { control: 'select', options: ["short","long"] }
  },
};
