...
const catData = allCats.find(c => c.name === "Breadcrumbs component");
...
export default {
  title: "Tokens   Atoms/Breadcrumbs component",
  component: BreadcrumbsComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["Desktop","Mobile"] },
    "Style": { control: 'select', options: ["Contrast","Primary"] },
    "Amount": { control: 'select', options: ["3","2","1","4"] },
    "State": { control: 'select', options: ["Active","Default","Hover"] }
  },
};
