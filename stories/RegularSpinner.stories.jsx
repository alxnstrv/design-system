...
const catData = allCats.find(c => c.name === "Regular Spinner");
...
export default {
  title: "Tokens   Atoms/Regular Spinner",
  component: RegularSpinner,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Property 1": { control: 'select', options: ["Frame 16","Frame 17","Frame 18","Frame 19"] }
  },
};
