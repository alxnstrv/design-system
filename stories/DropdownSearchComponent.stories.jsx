...
const catData = allCats.find(c => c.name === "Dropdown Search Component");
...
function DropdownSearchComponent(props) {
...
export default {
  title: "Tokens   Atoms/Dropdown Search Component",
  component: DropdownSearchComponent,
  parameters: { layout: 'fullscreen' },
  argTypes: {
    "Device": { control: 'select', options: ["mobile","desktop"] },
    "State": { control: 'select', options: ["Reopened","Typing","NonActive","hover","Active","Error","default","Selected","Filled"] },
    "Multiselect": { control: 'select', options: ["false","true"] },
    "Type": { control: 'select', options: ["Grey","Default"] }
  },
};
